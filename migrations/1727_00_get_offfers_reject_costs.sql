...
Delete from Core using Usersettings.Core Core, Usersettings.ActivePrices Prices  where Cost > 950000  and Prices.PriceCode=Core.PriceCode and Prices.FirmCode in(2778,10967,234,228, 3492);


Delete from Core
using Usersettings.Core Core, Usersettings.ActivePrices Prices
where Cost = 99999.99
	and Prices.PriceCode = Core.PriceCode
	and Prices.FirmCode in (3492);
